...
Performed Fama-French factor attribution to isolate alpha from common risk factors (Market, Size, Value).
...
**NLP:** FinBERT (HuggingFace Transformers) · **Data:** pandas, numpy, yfinance · **Compute:** PyTorch with GPU (Google Colab T4) · **Statistics:** statsmodels
